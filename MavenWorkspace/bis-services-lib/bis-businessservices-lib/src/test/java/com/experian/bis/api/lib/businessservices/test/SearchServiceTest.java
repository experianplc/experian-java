...
public class SearchServiceTest extends ServiceTestBase{
	...
	public void testExecute() {
		try {
			SearchService service = new SearchService(getServiceCredential(), getProxy());
...
//			Assert.assertEquals(response.getResults()!=null  
//					&& response.getResults().getMatchingNameAndAddress()!=null 
