...
import com.experian.bis.api.lib.businessservices.bean.request.BusinessAggregatesServiceRequest;
import com.experian.bis.api.lib.businessservices.bean.request.BusinessServiceRequest;
import com.experian.bis.api.lib.businessservices.bean.response.AggregatesServiceResponse;
...
public class AggregatesService extends BusinessService{
	private static final String SERVICE_ID = "aggregates";
	 ...
	 */
	public AggregatesService(BISServiceCredential serviceCredential) {
	 ...
	 * @param proxy
	 */
	public AggregatesService(Proxy proxy) {
		super(proxy);
	}
	 ...
	 */
	public AggregatesService(BISServiceCredential serviceCredential, Proxy proxy) {
	...
	public BusinessServiceResponse execute(BusinessServiceRequest businessServiceRequest) throws BISServiceException {
		BusinessAggregatesServiceRequest request = (BusinessAggregatesServiceRequest) businessServiceRequest;
		...
		AggregatesServiceResponse response = (AggregatesServiceResponse) parseResponseToObject(AggregatesServiceResponse.class);
		return response;
	}
